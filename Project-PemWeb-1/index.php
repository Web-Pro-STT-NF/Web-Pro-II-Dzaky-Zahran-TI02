        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <form action="" method="POST">
                  ...
                  <div class="form-group row">
                      <div class="offset-4 col-8">
                          ...
                          <button name="back" href="index.php" class="btn btn-light">Back</button>
                      </div>
                  </div>
              </form>
              </div>
              ...
              Mohon isi form diatas sehingga data dapat ditampilkan.
              </div>
              <?php
              error_reporting(0);
              ?>
          ...
          <div class="card">
              ...
              <table class="table table-light  table-striped mt-1">
                  ...
                  <?php
                      $pasien1 = new bmiPasien('Dafa', 'Jakarta', '2022-01-10', '1.com', 'L', 45.2, 171, 'P001');
                      $pasien2 = new bmiPasien('Azka', 'Bandung', '2022-01-10', '2.com', 'P', 55.3, 165, 'P002');
                      $pasien3 = new bmiPasien('Fauzan', 'Depok', '2022-01-11', '3.com', 'L', 68, 174, 'P003');
                      $pasien4 = new bmiPasien('Irfan', 'Depok', '2022-01-11', '4.com', 'L', 59.8, 166, 'P004');

                  
                  
                      // panggil attribut dari class Pasien
                      $dataPasien = [$pasien1, $pasien2, $pasien3, $pasien4];
                      $nomor = 1;
                      $kode = 1;
