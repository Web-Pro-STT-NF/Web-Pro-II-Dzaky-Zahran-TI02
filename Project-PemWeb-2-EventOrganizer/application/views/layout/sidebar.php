   ...
   <aside class="main-sidebar sidebar-dark-primary elevation-4">
       ...
       <a href="<?php echo base_url() ?>index3.html" class="brand-link">
           ...
           <span class="brand-text font-weight-light">Project 2 PemWeb</span>
       </a>
       ...
       <div class="sidebar">
           ...
           <div class="user-panel mt-3 pb-3 mb-3 d-flex">
               <div class="image">
                   <img src="<?php echo base_url() ?>dist/img/layy.jpeg" class="img-circle elevation-2" alt="User Image">
               </div>
               <div class="info">
                   <a href="#" class="d-block">M. Dzaky Zahran TI02</a>
               </div>
           </div>
